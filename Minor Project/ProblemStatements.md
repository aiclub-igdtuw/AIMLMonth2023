...
<li>Perform feature encoding or transformation on categorical variables (such as gender, drug) in the dataset. Which encoding technique would be most suitable?</li>
